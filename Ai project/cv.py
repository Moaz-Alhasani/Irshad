...
# =========================
# التحقق إذا النص يشبه سيرة ذاتية
# =========================
def is_likely_cv(text):
    text_lower = text.lower()
    cv_keywords = [
...
Rules:
- In "summary", provide a concise professional overview (1-3 sentences).
- In "skills", extract only programming languages, frameworks, libraries, AI/ML/NLP tools, LLMs, and generative AI technologies.
- Do NOT include soft skills or conceptual skills like "OOP", "Teamwork", etc.
- Return strictly valid JSON only.
"""
    ...
    try:
        ...
        print("Raw output:", raw_output if 'raw_output' in locals() else "")
        return {}


# =========================
# تحليل السيرة الكاملة
# =========================
def analyze_resume_with_gemini(file_path):
    print("Extracting text...")
    resume_text = extract_text(file_path)
